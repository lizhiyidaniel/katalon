...
def setUp( ) {
	...
	'Invite'
	WebUI.callTestCase(findTestCase('Test Cases/Common Test Cases/Test/Invite Candidate With Question'), ['name':validNameUnique, 'email':validEmail,'inviteName':validName, 'duration':true , 'multipe': false, 'snapshot': true ])
	'Connect DB'
