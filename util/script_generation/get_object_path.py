...
scripts_list = pkl.load(open('pickle_files/pickle_files_for_script_generation/script_list.pkl', "rb"))
path_dict_c = pkl.load(open('pickle_files/pickle_files_for_script_generation/path_dict_c.pkl', "rb"))
alternate_dict_c = pkl.load(open('pickle_files/pickle_files_for_script_generation/alternate_dict_c.pkl', "rb"))
action_widget = pkl.load(open('pickle_files/pickle_files_for_script_generation/action_widget.pkl', "rb"))
